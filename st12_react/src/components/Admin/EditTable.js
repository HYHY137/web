            ...
            {numSelected > 0 ? (
                ...
                <Tooltip title="Delete" onClick={deleteSelected}>
                    ...
                    <Tooltip title="Add dish" >
                        <IconButton aria-label="add dish" onClick={addDish}>
...
export default function EditTable() {
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelecteds = data.dishes.map((n) => n._id);
    ...
    const deleteSelected = () => {
        ...
        setData({
            dishes : data.dishes.filter((dish)=> !selected.includes(dish._id))
            });
        setSelected([]);
    }

    const emptyRows = rowsPerPage - Math.min(rowsPerPage, data.dishes.length - page * rowsPerPage);
                ...
                <TableContainer>
                    ...
                    >
                        <EnhancedTableHead
                            ...
                            rowCount={data.dishes.length}
                        />
                        <TableBody>
                            {stableSort(data.dishes, getComparator(order, orderBy))
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell padding="none">
                                                <Tooltip title="Edit">
                                                    <IconButton aria-label="edit" onClick={(event) => handleEditClick(event, row._id)}>
                                                        <EditIcon />
                                                    </IconButton>
                                                </Tooltip>
                                            </TableCell>
